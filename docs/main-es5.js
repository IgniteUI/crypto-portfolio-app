...
var AppComponent = /** @class */ (function () {
    function AppComponent(router, afAuth) {
        ...
        try {
            for (var routes_1 = __values(_app_routing_module__WEBPACK_IMPORTED_MODULE_3__["routes"]), routes_1_1 = routes_1.next(); !routes_1_1.done; routes_1_1 = routes_1.next()) {
...
var BlockGridComponent = /** @class */ (function () {
            ...
            if (args.groupedColumns instanceof Array && args.groupedColumns.length !== 0) {
                ...
                if (colNotForGroup) {
                    ...
                    if (args.groupedColumns.find(function (col) { return col.field === 'dailyScale'; }) === undefined) {
                        _this.grid1.groupBy({ fieldName: 'dailyScale', dir: igniteui_angular__WEBPACK_IMPORTED_MODULE_2__["SortingDirection"].Asc });
                    }
                }
            }
    ...
    BlockGridComponent.ctorParameters = function () { return [
...
var BlockListComponent = /** @class */ (function () {
    ...
    BlockListComponent.ctorParameters = function () { return [
        { type: _services_data_service__WEBPACK_IMPORTED_MODULE_1__["DataService"] }
    ]; };
...
module.exports = "a {\n  color: #731963; }\n\n.links {\n  text-align: center;\n  padding: 0 35px; }\n\n#linksContainer {\n  flex-flow: row wrap;\n  display: flex;\n  justify-content: center; }\n\n.card-wrapper {\n  max-width: 279px;\n  min-width: 260px; }\n\n.searchBox {\n  width: 100%;\n  padding-left: 15px;\n  padding-right: 15px; }\n\n.sample-content {\n  display: flex;\n  margin: 0 auto;\n  justify-content: flex-start; }\n\n.igx-card-header,\n.igx-card-header__title {\n  display: flex;\n  flex-direction: column;\n  align-items: center; }\n\n.igx-card-content {\n  text-align: left; }\n\n.igx-card-header {\n  padding-bottom: 0 !important; }\n\n.igx-card-header {\n  font-size: 18px; }\n\n.igx-card-header img {\n    width: 32px;\n    height: 32px;\n    margin-bottom: 8px; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var StatisticsComponent = /** @class */ (function () {
    ...
    StatisticsComponent.prototype.getData = function (event) {
        ...
        var coin;
        if (event) {
            var name_1 = event.item.elementRef.nativeElement.innerText.trim();
