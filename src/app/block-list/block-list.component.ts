...
import { IgxFilterOptions, IgxInputGroupModule, IgxPrefixModule, IgxIconModule, IgxSuffixModule, IgxListModule, IgxAvatarModule, IgxFilterModule } from 'igniteui-angular';
