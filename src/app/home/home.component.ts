...
import { IgxFilterOptions, IgxExpansionPanelComponent, IgxInputGroupModule, IgxPrefixModule, IgxIconModule, IgxSuffixModule, IgxCardModule, IgxDividerModule, IgxButtonModule, IgxRippleModule, IgxFilterModule } from 'igniteui-angular';
